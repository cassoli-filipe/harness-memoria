...
# emenda: [ADR-NNNN]             # se este muda UMA decisão de outro sem revogar as demais
# emendado-por: [ADR-NNNN]       # preenchido quando ESTE for parcialmente emendado — o
                                  # status dele não muda; ver /novo-adr para a distinção
---
